...
const UserDashboard = () => {
  ...
  const downloadHoldingsAsCSV = () => {
    ...
    const csvContent =
      ...
      [`Report Generated On: ${timestamp}`, headers.join(","), ...rows.map(e => e.join(","))].join("\n");
  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center">
        ...
        />
        <Tooltip title="Export your holdings summary as CSV (includes timestamp)">
          <Button
      ...
      {liveHoldings.length > 0 ? (
            ...
            {liveHoldings.map((stock, i) => (
              ...
              >
                <Box>
                  ...
                  <Typography color={colors.grey[400]} fontSize="11px">
                    As of: {timestamp}
                  </Typography>
                </Box>
                <Box textAlign="right">
        ...
        <Typography
          ...
          fontStyle="italic"
        >
          No stocks purchased or sold yet. Use the "Purchase" tab to begin trading.
        </Typography>
      )}
    </Box>
  );
